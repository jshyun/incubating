...
public class CDNSKEYRecordTest extends AbstractRecordTest {
    ...
    public void testBasic() {
        ...
        CDNSKEYRecord r = new CDNSKEYRecord(STD_NAME, STD_CLASS, STD_TTL, flags, protocol, algorithm, publicKey);
