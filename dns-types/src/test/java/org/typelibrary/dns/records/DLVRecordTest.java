...
public class DLVRecordTest extends AbstractRecordTest {
    ...
    public void testBasic() {
        ...
        DLVRecord r = new DLVRecord(STD_NAME, STD_CLASS, STD_TTL, keyTag, algorithm,
                digestType, digest);
        ...
        try {
            new DLVRecord(null, STD_CLASS, STD_TTL, keyTag, algorithm,
                    digestType, digest);
        ...
        try {
            new DLVRecord(STD_NAME, STD_CLASS, STD_TTL, keyTag, null,
                    digestType, digest);
            Assert.fail("Expected IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
            // Expected
        ...
        try {
            new DLVRecord(STD_NAME, STD_CLASS, STD_TTL, keyTag, algorithm,
                    null, digest);
            Assert.fail("Expected IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
            // Expected
